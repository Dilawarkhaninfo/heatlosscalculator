...
>
    <div>
        <a href="{{ route('home') }}" class="block py-navbar-item pl-5"> <i class="fas fa-calculator px-[2px]"></i> HeatLoss Calculator </a>
    </div>
    <!-- Responsive Menu -->
    <div
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col items-center">
            <li>
                ...
                >
                <i class="fas fa-calculator px-[2px]"></i>
                     Mini Calculator
                </a>
            </li>
            @if (!Auth::guest())
